Public Class RegistrasiUser
    ...
    Private Sub RegistrasiUser_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ProdiCombo1.Items.AddRange(cek(3).Split(","))
        RankCombo1.Items.AddRange(cek(2).Split(","))
    End Sub
    ...
    Private Sub Inboxbutton_Click(sender As Object, e As EventArgs) Handles Inboxbutton.Click
        Data = CStr(KoneksiRegistrasiUser.CheckInbox("Inbox/""" & SHA256(mail) & """/RegisterUser")).Split("\")
    ...
    Private Sub Guna2Button1_Click(sender As Object, e As EventArgs) Handles Guna2Button1.Click
        If Data1.Checked Then
            ...
            RankCombo1.Text = Data(4).Split("|")(NumericUpDown1.Value * 5 - 4)
            ProdiCombo1.Text = Data(5).Split("|")(NumericUpDown1.Value * 5 - 4)
        ElseIf Data2.Checked Then
            ...
            RankCombo1.Text = Data(4).Split("|")(NumericUpDown1.Value * 5 - 3)
            ProdiCombo1.Text = Data(5).Split("|")(NumericUpDown1.Value * 5 - 3)
        ElseIf Data3.Checked Then
            ...
            RankCombo1.Text = Data(4).Split("|")(NumericUpDown1.Value * 5 - 2)
            ProdiCombo1.Text = Data(5).Split("|")(NumericUpDown1.Value * 5 - 2)
        ElseIf Data4.Checked Then
            ...
            RankCombo1.Text = Data(4).Split("|")(NumericUpDown1.Value * 5 - 1)
            ProdiCombo1.Text = Data(5).Split("|")(NumericUpDown1.Value * 5 - 1)
        ElseIf Data5.Checked Then
            ...
            RankCombo1.Text = Data(4).Split("|")(NumericUpDown1.Value * 5)
            ProdiCombo1.Text = Data(5).Split("|")(NumericUpDown1.Value * 5)
        Else
    ...
    Private Sub Guna2Button2_Click(sender As Object, e As EventArgs) Handles Guna2Button2.Click
        ...
        If sum > -1 Then
            ...
            KoneksiRegistrasiUser.DeleteInbox("Inbox/""" & SHA256(mail) & """/RegisterUser", fix1, fix2, fix3, fix4, fix5, fix6, fix7)
            Inboxbutton.PerformClick()
        End If
